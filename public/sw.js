const STATIC_CACHE="bn-trip-static-v1";
const PRIVATE_DATA_CACHE="bn-trip-private-data-v1";
const PRIVATE_DOCUMENT_CACHE="bn-trip-private-documents-v1";
const STATIC_ASSETS=["/manifest.webmanifest","/bn-trip-icon-orange-192.png","/bn-trip-icon-orange-512.png","/travel-postcard-fallback.jpg"];

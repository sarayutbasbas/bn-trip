...
function buildTrips(){
  ...
  return [
    {id:"d1000000-0000-4000-8000-000000000001",owner_id:DEMO_USER_ID,name:"Kyoto Slow Days",destination:"Kyoto, Japan",country_code:"JP",start_date:ongoingStart,total_days:5,traveller_count:2,budget_thb:"45000.00",shopping_budget_thb:"12000.00",actual_spent_thb:4138.2,outbound_departure_at:timestamp(ongoingStart,"08:30"),return_departure_at:timestamp(ongoingEnd,"19:00"),cover_image_url:"/travel-postcard-background.jpg",google_photos_url:null,access_role:"owner",members:[]},
    {id:"d1000000-0000-4000-8000-000000000002",owner_id:DEMO_USER_ID,name:"Fukuoka Food Trip",destination:"Fukuoka, Japan",country_code:"JP",start_date:upcomingStart,total_days:5,traveller_count:2,budget_thb:"60000.00",shopping_budget_thb:"15000.00",actual_spent_thb:1280.4,outbound_departure_at:timestamp(upcomingStart,"07:15"),return_departure_at:timestamp(upcomingEnd,"21:20"),cover_image_url:"/travel-postcard-fallback.jpg",google_photos_url:null,access_role:"owner",members:[]},
    {id:"d1000000-0000-4000-8000-000000000003",owner_id:DEMO_USER_ID,name:"Hokkaido Winter Memory",destination:"Sapporo, Japan",country_code:"JP",start_date:pastStart,total_days:4,traveller_count:2,budget_thb:"80000.00",shopping_budget_thb:"20000.00",actual_spent_thb:121,outbound_departure_at:timestamp(pastStart,"09:00"),return_departure_at:timestamp(pastEnd,"18:30"),cover_image_url:"/travel-postcard-background.jpg",google_photos_url:null,access_role:"owner",members:[],review_average:5,review_count:1},
  ];
}

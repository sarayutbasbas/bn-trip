  ...
  try {
    ...
    const saved = await transaction(async (client) => {
      ...
      const result = await client.query<{
        ...
        (trip_id,name,location,description,check_in_day,check_out_day,check_in_time,check_out_time,
